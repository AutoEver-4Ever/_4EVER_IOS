//
//  InvoiceHeaderBar.swift
//  Erp4ever-iOS
//
//  Header with title and circular glass search button expanding to a search field (company).
//

import SwiftUI

struct InvoiceHeaderBar: View {
        ...
        HStack(spacing: 8) {
            if isSearchMode {
                HStack(spacing: 8) {
                    ...
                    TextField("거래처명으로 검색", text: $searchText)
