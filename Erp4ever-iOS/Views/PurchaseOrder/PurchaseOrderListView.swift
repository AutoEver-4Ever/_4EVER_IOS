...
struct PurchaseOrderListView: View {
    ...
    @State private var showTypePrompt: Bool = false
            ...
            VStack(spacing: 0) {
                ...
                PurchaseOrderHeaderBar(
                    ...
                    onSearch: { text, type in
                        ...
                        let keywordValue: String? = trimmed.isEmpty ? nil : trimmed
                        let typeValue: String? = trimmed.isEmpty ? nil : type
                        vm.applySearch(type: typeValue, keyword: keywordValue)
                    }
                )
                ...
                ScrollView {
                    if isSearchMode && showTypePrompt {
                        PurchaseOrderTypePromptView(selectedType: $searchType)
                    }
